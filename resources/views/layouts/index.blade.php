            ...
            <div class="col-sm-4 search-form-col">
                <form action="#" method="get" class="search-form">
                    <div class="input-group">
                        <span class="input-group-addon"><img src="{{URL::asset('home/images/search-icon-white.png')}}" alt=""></span>
                        <input type="search" class="form-control" placeholder="search">
                    </div>
                </form>
            </div>
            <div class="col-sm-4 logo-col text-center">
                <a href="{{url('/')}}"><img src="{{URL::asset('home/images/logo-white-green.png')}}" alt=""></a>
            </div>
            <div class="col-sm-4 menu-trigger-col">
                <button class="menu-trigger pull-right">
                    <span class="active-page">home</span>
                    <img src="{{URL::asset('home/images/menu-align-white.png')}}" alt="" class="icon-burger">
                    <img src="{{URL::asset('home/images/menu-close-white.png')}}" alt="" class="icon-cross">
                </button>
            </div>
        </div>
    </div>
                        ...
                        <ul class="nav column-menu black-bg">
                            <li class="active dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{url('/')}}">Home Option 6</a></li>
                                </ul>
                            </li>
    ...
    <div class="container">
        <div class="row top-footer">
            <div class="widget col-sm-3 widget-about">
                <div class="row m0"><a href="index.html"><img src="{{URL::asset('home/images/logo-black-green.png')}}" alt=""></a></div>
            </div>
            <div class="widget col-sm-5 widget-menu">
                <div class="row">
                    <ul class="nav column-menu white-bg">
                        ...
                        <li><a href="{{url('about')}}">About</a></li>
                        <li><a href="single.blade.php{{url('article')}}">Blog Single 1</a></li>
                        <li><a href="single2.blade.php{{url('article2')}}">Blog Single 2</a></li>
                    </ul>
                    <ul class="nav column-menu white-bg">
                        <li><a href="single3.blade.php">Blog Single 3</a></li>
