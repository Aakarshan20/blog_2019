    ...
    <div class="site-content">
        <div class="mdl-grid site-max-width">
            <div class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp page-content">
                ...
                <div class="mdl-card__media"><img class="article-image" src="{{URL::asset('portal/img/about.jpg')}}" border="0" alt="About">
                </div>
                <div class="mdl-grid site-copy">
                    <div class="mdl-cell mdl-cell--12-col"><h3
                            class="mdl-cell mdl-cell--12-col mdl-typography--headline">Introduction</h3>
